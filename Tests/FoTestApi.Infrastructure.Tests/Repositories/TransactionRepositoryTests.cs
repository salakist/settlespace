...
{
    private static IAsyncCursor<TransactionEntity> BuildCursor(IEnumerable<TransactionEntity> items)
    {
        var list = items.ToList();
        var cursor = new Mock<IAsyncCursor<TransactionEntity>>();
    ...
    private static Mock<IMongoCollection<TransactionEntity>> BuildCollectionMock(IEnumerable<TransactionEntity> findResults)
    {
        var mock = new Mock<IMongoCollection<TransactionEntity>>();
        mock.Setup(c => c.FindAsync(
                It.IsAny<FilterDefinition<TransactionEntity>>(),
                It.IsAny<FindOptions<TransactionEntity, TransactionEntity>>(),
