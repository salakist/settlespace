...
## Commands
- `dotnet test Tests/FoTestApi.Application.Tests/FoTestApi.Application.Tests.csproj --filter "FullyQualifiedName~Auth"`

## Dependencies
- `FoTestApi.Domain` contracts (`IPersonRepository`, password services)
