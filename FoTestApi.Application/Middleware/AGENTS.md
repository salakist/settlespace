...
## Commands
- `dotnet test Tests/FoTestApi.Application.Tests/FoTestApi.Application.Tests.csproj --filter "FullyQualifiedName~ExceptionHandlingMiddleware"`

## Dependencies
- Domain exception types and ASP.NET Core middleware contracts

## Source-of-truth note
Cross-context application policy (DI, host wiring, artifact ownership, gate workflow) is defined in `FoTestApi.Application/AGENTS.md` and root `AGENTS.md`.
