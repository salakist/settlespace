...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "SettleSpace API",
        Version = "v1"
    });

    c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
    {
        Description = "Use /auth/login to get a JWT, then enter it here as: Bearer {token}",
        Name = "Authorization",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "SettleSpace API";
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "SettleSpace API v1");
