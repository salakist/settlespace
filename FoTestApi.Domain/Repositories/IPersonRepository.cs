...
namespace FoTestApi.Domain.Repositories
{
    ...
    public interface IPersonRepository
    {
        ...
        Task<PersonEntity?> GetByIdAsync(string id);
        ...
        Task<List<PersonEntity>> SearchAsync(string query);
        ...
        /// <returns>The person if found; otherwise null.</returns>
        Task<PersonEntity?> FindByFullNameAsync(string firstName, string lastName);
        ...
        Task UpdateAsync(string id, PersonEntity person);
