...
function getSearchInput() {
  return screen.getByLabelText(TRANSACTION_TEST_TEXT.SEARCH_ARIA_LABEL);
}
...
test('submits free text on form submit', async () => {
  ...
  userEvent.type(screen.getByLabelText(TRANSACTION_TEST_TEXT.SEARCH_ARIA_LABEL), 'lunch');
...
test('selecting Payee enters sub-input mode and adds a chip', async () => {
  ...
  await clickOption(TRANSACTION_TEST_TEXT.ALICE_JOHNSON);
